...
//        applicationMetadata.setProjectPath(System.getProperty("user.dir"));
        ...
        applicationMetadata.setClassName("DemoApplication");
        ...
        projectMetadata.setName("demo1");
        projectMetadata.setDescription("This demo for auto generation");
//        projectMetadata.setVersion("0.0.1-SNAPSHOT");
        projectMetadata.setAlias("交易中心");
